...
# CREATE USER 'admin'@'localhost' IDENTIFIED BY '$2a$12$NLSZfZAX8uCc4j/aFL8f4OawOY2XmVMLEG8lF4wrUsqBrgatLsVmy';
#
...
VALUES (1, 'Toyota Sera', 'The Toyota Sera was not a particularly powerful car. It had a 1.5-liter 4-Cylinder engine that only put out 108hp and even though the car weighed only 900kg, this sort of power output was hardly enough for anything other than average road performance.'),
       ...
       (6, '1959 Toyopet Crown', 'The Toyopet Crown marked Toyota’s first real foray into the American market and unfortunately, things did not go quite as planned. For one, the cars were grossly unsuited to the American driving style. They were also too heavy and underpowered with power output rated at a puny 60hp.'),
       ...
       (9, 'Toyota SA', 'This vehicle was the first passenger vehicle produced by Toyota after the end of World War 2 and it marked the beginning of the company’s commercial passenger vehicle production. The car bore some resemblance to the Volkswagen Beetle with its curvy lines.'),
       (10, 'Toyota MR2 TTE Turbo', 'The third-generation MR2 packed a 138hp 4-cylinder engine but there were certain customers who felt that power was not enough for the nimble sports car. In Europe, Toyota responded to these customers by offering a limited-edition turbo package for the MR2s.');
